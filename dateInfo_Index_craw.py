...
class Crawler():
  def __init__(self):
    ...
    self.url = "https://www.twse.com.tw/rwd/zh/TAIEX/MI_5MINS_HIST"
...
for Y in range(start_year, end_year+1):
  ...
  for M in range(1, ED_M+1):
    ...
    PATH = "../stock_data/date_info/stock_indexs/TAIEX 加權指/total_index/{0}_{1:02}.json".format(Y,M)
