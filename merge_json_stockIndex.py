...
for Y in range(start_year, end_year + 1):
    ...
    for M in range(1, ED_M + 1):
        PATH1 = "../stock_data/date_info/stock_indexs/TAIEX 加權指/total_index/{0}_{1:02}.json".format(
            Y, M
        )
        PATH2 = "../stock_data/date_info/stock_indexs/TAIEX 加權指/volume/{0}_{1:02}.json".format(
            Y, M
        )
...
storage_PATH1 = (
    "../stock_data/total_date/stock_indexs/TAIEX 加權指/total_index.json".format(Y, M)
)
storage_PATH2 = "../stock_data/total_date/stock_indexs/TAIEX 加權指/volume.json".format(
    Y, M
)
