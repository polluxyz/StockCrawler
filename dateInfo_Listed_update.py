...
for stock_info in stock_info_list["stock"]:
  ...
  PATH = "../stock_data/date_info/stocks/{2} {3}/{0}_{1:02}.json".format(year,month,stock_no,stock_name)
  ...
  if last_json != today_json:
    ...
    while last_json != judge_json:
      last_path = "../stock_data/date_info/stocks/{} {}/{}".format(stock_no,stock_name,last_json)
